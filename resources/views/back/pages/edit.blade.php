    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('back.pages.update', $page) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="status" name="status" value="1" {{ old('status', $page->status) ? 'checked' : '' }}>
